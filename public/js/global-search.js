// Chức năng tìm kiếm toàn cục cho tất cả các trang
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Kiểm tra xem đã tồn tại phần tử kết quả tìm kiếm chưa
    ...
    if (!searchResults) {
        ...
        // Tạo container nội dung kết quả
        ...
        searchResultsContainer = searchResults.querySelector('.search-results-container');
    }
